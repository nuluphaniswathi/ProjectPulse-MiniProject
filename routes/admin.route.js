...
const {createProject,ReadAllProjects,getSpecificProjectDetails,updateProject,deleteProject,lastTwoWeeksUpdates}=require("../controllers/admin.controller")
...
adminApp.get("/admin/portfolio-dashboard",verifyToken,ReadAllProjects);
